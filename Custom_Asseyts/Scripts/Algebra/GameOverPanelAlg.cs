...
namespace Game
{
    public class GameOverPanelAlg : ShowHidable
    {
        ...
        public override void Show(bool animate = true, Action completed = null)
        {
            ...
            _scoreTxt.text = LevelManagerAlg.Instance.Score.ToString();
            _bestTxt.text = $"BEST - {GameManager.BEST_SCORE}";

            if (LevelManagerAlg.Instance.BestScoreArchived && RatingPopUp.Available)
            {
