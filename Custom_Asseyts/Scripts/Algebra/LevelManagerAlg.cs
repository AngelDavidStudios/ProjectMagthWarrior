...
namespace Game
{
    public class LevelManagerAlg : MonoBehaviour
    {
        public static LevelManagerAlg Instance { get; private set; }
        ...
        {
            return ResourceManager.QuizzesAlge.GetRandom().Randomize();
        }
