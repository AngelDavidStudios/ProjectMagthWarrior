...
namespace Game
{
    public class LevelManagerArithmetic : MonoBehaviour
    {
        public static LevelManagerArithmetic Instance { get; private set; }
        ...
        {
            return ResourceManager.QuizzesArith.GetRandom().Randomize();
        }
