...
namespace Game
{
    public class GameOverPanelGeom : ShowHidable
    {
        ...
        public override void Show(bool animate = true, Action completed = null)
        {
            ...
            _scoreTxt.text = LevelManagerGeom.Instance.Score.ToString();
            _bestTxt.text = $"BEST - {GameManager.BEST_SCORE}";

            if (LevelManagerGeom.Instance.BestScoreArchived && RatingPopUp.Available)
            {
