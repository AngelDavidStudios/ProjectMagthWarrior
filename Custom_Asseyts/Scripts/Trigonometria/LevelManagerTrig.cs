...
namespace Game
{
    public class LevelManagerTrig : MonoBehaviour
    {
        public static LevelManagerTrig Instance { get; private set; }
        ...
        {
            return ResourceManager.QuizzesTrig.GetRandom().Randomize();
        }
